...
export const AccountUpdateMultiEnd: MessageFns<AccountUpdateMultiEnd> = {
  ...
  create(base?: DeepPartial<AccountUpdateMultiEnd>): AccountUpdateMultiEnd {
    return AccountUpdateMultiEnd.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<AccountUpdateMultiEnd>): AccountUpdateMultiEnd {
    const message = createBaseAccountUpdateMultiEnd();
