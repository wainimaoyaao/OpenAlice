...
export const AccountUpdateMulti: MessageFns<AccountUpdateMulti> = {
  ...
  create(base?: DeepPartial<AccountUpdateMulti>): AccountUpdateMulti {
    return AccountUpdateMulti.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<AccountUpdateMulti>): AccountUpdateMulti {
    const message = createBaseAccountUpdateMulti();
