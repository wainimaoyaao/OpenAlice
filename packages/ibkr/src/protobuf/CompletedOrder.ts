...
function createBaseCompletedOrder(): CompletedOrder {
  return { contract: undefined, order: undefined, orderState: undefined };
}

export const CompletedOrder: MessageFns<CompletedOrder> = {
  encode(message: CompletedOrder, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CompletedOrder {
  ...
  create(base?: DeepPartial<CompletedOrder>): CompletedOrder {
