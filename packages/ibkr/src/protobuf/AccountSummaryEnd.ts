...
export const AccountSummaryEnd: MessageFns<AccountSummaryEnd> = {
  ...
  create(base?: DeepPartial<AccountSummaryEnd>): AccountSummaryEnd {
    return AccountSummaryEnd.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<AccountSummaryEnd>): AccountSummaryEnd {
    const message = createBaseAccountSummaryEnd();
