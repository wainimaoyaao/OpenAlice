...
export const CancelAccountSummary: MessageFns<CancelAccountSummary> = {
  ...
  create(base?: DeepPartial<CancelAccountSummary>): CancelAccountSummary {
    return CancelAccountSummary.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CancelAccountSummary>): CancelAccountSummary {
    const message = createBaseCancelAccountSummary();
