...
export const CancelAccountUpdatesMulti: MessageFns<CancelAccountUpdatesMulti> = {
  ...
  create(base?: DeepPartial<CancelAccountUpdatesMulti>): CancelAccountUpdatesMulti {
    return CancelAccountUpdatesMulti.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CancelAccountUpdatesMulti>): CancelAccountUpdatesMulti {
    const message = createBaseCancelAccountUpdatesMulti();
