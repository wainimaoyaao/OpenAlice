...
export const PositionsRequest: MessageFns<PositionsRequest> = {
  encode(_: PositionsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
  ...
  fromJSON(_: any): PositionsRequest {
    return {};
  },

  toJSON(_: PositionsRequest): unknown {
    const obj: any = {};
    return obj;
  },
  ...
  fromPartial(_: DeepPartial<PositionsRequest>): PositionsRequest {
    const message = createBasePositionsRequest();
    return message;
  },
};
